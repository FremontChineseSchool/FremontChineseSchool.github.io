      ...
      slots: [
        ...
        },
        {
          ...
          classes: [
            ...
            {
              code: 'BC1',
              name: 'Python Coding — Beginner (兒童初級電腦程式班)',
              materialFee: null,
              materialsNote: 'Bring own laptop',
              description: 'Introduction to Python programming — variables, loops, and simple projects.',
              notes: null,
              adultsWelcome: false,
              isNew: false,
            },
        ...
        },
        {
          ...
          classes: [
            ...
            {
              code: 'IC1',
              name: 'Python Coding — Intermediate (兒童中級電腦程式班)',
              materialFee: null,
              materialsNote: 'Bring own laptop',
              description: 'Intermediate Python programming concepts and projects.',
              notes: null,
              adultsWelcome: false,
              isNew: true,
            },
      ...
      slots: [
        ...
        },
        {
          ...
          classes: [
            ...
            {
              code: 'BC1',
              name: '兒童初級電腦程式班（Python）',
              materialFee: null,
              materialsNote: '請自備筆記型電腦',
              description: '基礎 Python 程式設計入門，涵蓋變數、迴圈及簡單專案。',
              notes: null,
              adultsWelcome: false,
              isNew: false,
            },
        ...
        },
        {
          ...
          classes: [
            ...
            {
              code: 'IC1',
              name: '兒童中級電腦程式班（Python）',
              materialFee: null,
              materialsNote: '請自備筆記型電腦',
              description: '中級 Python 程式設計概念與專案實作。',
              notes: null,
              adultsWelcome: false,
              isNew: true,
            },
