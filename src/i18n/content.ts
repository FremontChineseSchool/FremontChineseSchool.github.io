  ...
  en: {
      ...
      slots: [
        ...
        },
        {
          ...
          classes: [
            ...
            {
              code: 'LSC',
              name: 'Language Support Club (中文會話社團)',
              materialFee: null,
              materialsNote: null,
              description: 'A student-led Chinese conversation club advised by Ms. Nicole Shieh. High-school students with strong Chinese lead the group, so members practice speaking through games, activities, and interaction rather than instruction. Alongside the conversation practice there are talent shows, crafts, and other hands-on activities, giving students more chances to use Chinese in a relaxed, enjoyable setting — building confidence and keeping them motivated to keep learning.',
    ...
    payment: {
      ...
      tuition: {
        ...
        policy: {
          title: 'Transfers, drops & refunds',
          transferLabel: 'Class transfer fee',
          transferValue: '$20',
          transferNote: 'You can transfer classes at any point in the year, including after the refund window has closed.',
          refundTitle: 'Tuition refund schedule',
          refundRows: [
            { window: 'On or before May 16, 2026', detail: 'Full refund' },
            { window: 'May 17 – Aug 22, 2026', detail: '70% refunded (30% drop fee)' },
            { window: 'After Aug 22, 2026', detail: 'No refund' },
          ],
          refundNote:
            'Only tuition is refundable. The $50 new-student registration fee is non-refundable.',
        },
        ...
        },
        {
          ...
          classes: [
            ...
            },
            {
              ...
              materialFee: null,
              materialsNote: null,
              description: '由謝宜靜老師擔任指導老師。中文會話社團以學生帶學生的方式進行，由中文程度良好的高中生帶領大家，在遊戲、活動和互動中練習中文口說。除了輕鬆有趣的中文活動，也會安排才藝表演、勞作製作及其他有趣活動，讓學生在快樂的學習過程中增加使用中文的機會，提升學習中文的興趣與動力。',
    ...
    payment: {
      ...
      tuition: {
        ...
        policy: {
          ...
          transferLabel: '轉班費',
          transferValue: '$20',
          transferNote: '全年皆可辦理轉班，退費期限截止後亦然。',
          refundTitle: '學費退費期限',
          refundRows: [
            { window: '2026 年 5 月 16 日（含）以前', detail: '全額退費' },
            { window: '2026 年 5 月 17 日至 8 月 22 日', detail: '退還 70%（收取 30% 退課手續費）' },
            { window: '2026 年 8 月 22 日以後', detail: '恕不退費' },
          ],
          refundNote: '僅學費可退；新生報名費 $50 恕不退還。',
        },
